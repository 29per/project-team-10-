...
namespace PlanEase.Views
{
            ...
            cmbPriority.Items.AddRange(new string[]
   {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                // 수정 모드
                editingSchedule.Title = txtTitle.Text.Trim();
                editingSchedule.StartTime = startTime;
                editingSchedule.EndTime = endTime;
                editingSchedule.Tags = tagList;
                editingSchedule.Priority = (PriorityLevel)(cmbPriority.SelectedIndex + 1);
                editingSchedule.Description = txtDescription.Text.Trim();

                scheduleManager.UpdateSchedule(editingSchedule);
            ...
            else
            {
                ...
                if (conflicts.Any())
                {
                    ...
                    var conflictForm = new ConflictResolutionForm(schedule, conflicts, resolver);
